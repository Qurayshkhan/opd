...
<body>
   ...
   <div class="header_section">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
         <div class="logo"><a href="{{route('home')}}"><h1>OPD</h1></a></div>
...
@endguest
               ...
               <div class="banner_section">
                  <div class="container">
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="image_1"><img src="{{asset('user_side_assets')}}/images/img-1.png"></div>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="health_section layout_padding">
      <div class="container">
         ...
         <div class="health_section layout_padding">
            <div class="row">
               <div class="col-sm-7">
                  <div class="image_main">
                     <div class="main">
                        <img src="{{asset('user_side_assets')}}/images/img-2.png" alt="Avatar" class="image" style="width:100%">
                     </div>
                     <div class="middle">
                        <div class="text"><img src="{{asset('user_side_assets')}}/images/icon-1.png" style="width: 40px;"></div>
                     </div>
                  </div>
               </div>
               <div class="col-sm-5">
                  <div class="image_main_1">
                     <div class="main">
                        <img src="{{asset('user_side_assets')}}/images/img-3.png" alt="Avatar" class="image" style="width:100%">
                     </div>
                     <div class="middle">
                        <div class="text"><img src="{{asset('user_side_assets')}}/images/icon-1.png" style="width: 40px;"></div>
                     </div>
            ...
            <div class="getquote_bt_1"><a href="#">Read More <span><img src="{{asset('user_side_assets')}}/images/right-arrow.png"></span></a></div>
         </div>
      </div>
   </div>
   <!-- health section end -->
      ...
      <div class="container">
         <div class="knowledge_main">
            ...
            <div class="right_main">
               <div class="play_icon"><a href="#"><img src="{{asset('user_side_assets')}}/images/play-icon.png"></a></div>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="news_section layout_padding">
      <div class="container">
         ...
         <div class="getquote_bt"><a href="#">Get A Quote <span><img src="{{asset('user_side_assets')}}/images/right-arrow.png"></span></a></div>
      </div>
   </div>
   <!-- news section end -->
            @yield('content')
               ...
               <div class="container">
                  ...
                  <div class="client_section_2">
                     <div class="client_left">
                        <div><img src="{{asset('user_side_assets')}}/images/client-img.png" class="client_img"></div>
                     </div>
                     <div class="client_right">
                        ...
                        <div class="quote_icon"><img src="{{asset('user_side_assets')}}/images/quote-icon.png"></div>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-lg-3 col-sm-6">
               <div class="footer_logo"><a href="index.html"><img src="{{asset('user_side_assets')}}/images/footer-logo.png"></a></div>
               <h1 class="adderss_text">Contact Us</h1>
               <div class="map_icon"><img src="{{asset('user_side_assets')}}/images/map-icon.png"><span class="paddlin_left_0">Page when looking at its</span></div>
               <div class="map_icon"><img src="{{asset('user_side_assets')}}/images/call-icon.png"><span class="paddlin_left_0">+7586656566</span></div>
               <div class="map_icon"><img src="{{asset('user_side_assets')}}/images/mail-icon.png"><span class="paddlin_left_0">volim@gmail.com</span></div>
            </div>
            <div class="col-lg-3 col-sm-6">
            ...
            <div class="col-lg-3 col-sm-6">
               ...
               <div class="social_icon">
                  <ul>
                     <li><a href="#"><img src="{{asset('user_side_assets')}}/images/fb-icon.png"></a></li>
                     <li><a href="#"><img src="{{asset('user_side_assets')}}/images/twitter-icon.png"></a></li>
                     <li><a href="#"><img src="{{asset('user_side_assets')}}/images/linkedin-icon.png"></a></li>
                     <li><a href="#"><img src="{{asset('user_side_assets')}}/images/instagram-icon.png"></a></li>
                  </ul>
               </div>
            </div>
         </div>
