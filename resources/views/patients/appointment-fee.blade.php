...
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                ...
                                onclick="appointmentFeeMethod('{{ $appointmentFee->id ?? '' }}', '{{ $appointmentFee->payment[0]->payment_fee ?? '' }}', '{{ $appointmentFee->payment[0]->id }}')">
                                Pay
                            </button>
                        </td>
                    </tr>
    ...
    <script>
        function appointmentFeeMethod(appointment_id, patient_appointment_fee, payment_id) {
