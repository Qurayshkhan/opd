        ...
        <div class="container">
           ...
           <div class="news_section_2">
              <div class="row">
                 <div class="col-md-6">
                    <div class="icon_main">
                       <div class="icon_7"><img src="{{asset('user_side_assets')}}/images/icon-7.png"></div>
                       <h4 class="diabetes_text">Diabetes and obesity Counselling </h4>
                    </div>
                    <div class="icon_main">
                       <div class="icon_7"><img src="{{asset('user_side_assets')}}/images/icon-5.png"></div>
                       <h4 class="diabetes_text">Obstetrics and Gynsecology</h4>
                    </div>
                    <div class="icon_main">
                       <div class="icon_7"><img src="{{asset('user_side_assets')}}/images/icon-6.png"></div>
